<div class="card sidebar">
    <div class="card-body">
        <ul class="nav flex-column">
            <li class="nav-item mx-auto"><a class="nav-link h6" href="./profile.php"><img class="d-block w-100 rounded-circle mx-auto mb-2" style="max-width: 80px" src="https://resize-parismatch.lanmedia.fr/img/var/news/storage/images/paris-match/people-a-z/michel-drucker/6000670-8-fre-FR/Michel-Drucker.jpg" alt="profile-picture"><?php echo getAuth()['first_name']?> <?php echo getAuth()['last_name']?></a></li>
